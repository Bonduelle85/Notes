            ...
            Scaffold(
                        ...
                        navigationIcon = {
                            Icon(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        viewModel.processCommand(EditNoteCommand.ClickBack)
                                    },
                        ...
                        actions = {
                            Icon(
                                modifier = Modifier
                                    .padding(end = 16.dp)
                                    .clickable {
                                        viewModel.processCommand(EditNoteCommand.ClickDelete)
                                    },
                ...
                Column(
                    ...
                    Button(
                        ...
                        onClick = {
                            viewModel.processCommand(EditNoteCommand.ClickSave)
                        }
                    ) {
                        Text(
                            text = "Save Note"
